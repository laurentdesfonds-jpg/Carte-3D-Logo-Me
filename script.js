...
card.forEach(el => {
  ...
  el.addEventListener('mouseleave', () => {
	...
	el.children[1].style.background = `radial-gradient(circle at 50% 30%, rgb(184,196,211), transparent)`;
  });
  
  el.addEventListener('click', () => {
    el.classList.toggle('expanded'); // Basculer l'agrandissement au clic
  });
});
